export default [
  {
    ...
    children: [
      ...
      '/技术总结/踩坑总结/多种方式控制gif动图暂停和播放',
      '/技术总结/踩坑总结/sessionStorage能在多个标签页之间共享数据吗',
      ...
      '/技术总结/踩坑总结/新颖的setTimeout替代方案',
      '/技术总结/踩坑总结/一些新颖的js数组方法',
      '/技术总结/踩坑总结/vue相关',
      '/技术总结/踩坑总结/前端常见的安全问题',
      '/技术总结/踩坑总结/取消请求的方法',
      '/技术总结/踩坑总结/网页截图相关',
      ...
      '/技术总结/踩坑总结/js打印的一些总结',
      '/技术总结/踩坑总结/前端速通Blob、File、FileReader、ArrayBuffer、Base64',
      '/技术总结/踩坑总结/url参数',
      ...
      '/技术总结/踩坑总结/常用的正则表达式',
      '/技术总结/踩坑总结/css常用单位',
      '/技术总结/踩坑总结/uniapp运行到mumu模拟器',
      '/技术总结/踩坑总结/uniapp无线调试相关',
      '/技术总结/踩坑总结/uniapp写APP整包升级更新',
      '/技术总结/踩坑总结/uniapp写APP消息推送方案',
      '/技术总结/踩坑总结/uniapp微信小程序版本更新提示',
      '/技术总结/踩坑总结/uniapp中返回上一个页面不会触发生命周期问题',
      '/技术总结/踩坑总结/uniapp中的navigateTo页面跳转传参丢失问题',
      '/技术总结/踩坑总结/HBuilderX真机调试提示没有检测到设备',
      '/技术总结/踩坑总结/ios各种证书发布教详述',
      '/技术总结/踩坑总结/ios-APP-上架流程',
      '/技术总结/踩坑总结/flex和grid',
      '/技术总结/踩坑总结/响应式网站布局技巧',
      '/技术总结/踩坑总结/移动端适配布局',
